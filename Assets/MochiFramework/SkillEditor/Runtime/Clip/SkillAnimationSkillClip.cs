...
namespace MochiFramework.Skill
{
    ...
    public class SkillAnimationSkillClip : SkillClip
    {
        ...
        {
            get => animationAsset;
            set => animationAsset = (AnimationClip)value;
        }
        ...
        [SerializeField] 
        protected AnimationClip animationAsset;
        ...
        // public static SkillAnimationSkillClip CreateAnimationClip(SkillTrack skillTrack,int startFrame, AnimationClip unityAnimationClip)
        // {
        ...
        // }
        //
        // public static SkillAnimationSkillClip CreateAnimationClip(SkillTrack skillTrack,int startFrame, AnimationClip unityAnimationClip,int duration)
        // {
